...
public class Types {
  ...
  @SuppressWarnings("unchecked")
  public static final Type<HashSet<Integer>> NEIGHBOURS_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  @SuppressWarnings("unchecked")
  public static final Type<HashMap<Integer, Double>> NEIGHBOURS_WEIGHTED_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  @SuppressWarnings("unchecked")
  public static final Type<HashMap<String, String>> SHORTEST_PATH_DISTANCES_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  @SuppressWarnings("unchecked")
  public static final Type<VertexShortestPathChange> VERTEX_SHORTEST_PATH_CHANGE_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          TypeName.typeNameOf(TYPES_NAMESPACE, "vertex_shortest_path_changes"),
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(bytes, new TypeReference<VertexShortestPathChange>() {}));

  public static final Type<HashMap<String, TreeMap<Integer, ArrayList<VertexActivity>>>>
  ...
  /** Type denoting a query of mini batch that is sent from ingress to storage */
  ...
  /** Type denoting a query of strongly connected component that is sent from ingress to storage */
  ...
  /** Type denoting a query of single source shortest path that is sent from ingress to storage */
  ...
  /** Type denoting a query of connected component that is sent from ingress to storage */
  ...
  /** Type denoting a query of mini batch with state sent from storage to application */
  ...
  /**
   * Type denoting a query of strongly connected component with state sent from storage to
   * application
   */
  ...
  public static final Type<ForwardQueryGNNSamplingWithState>
      FORWARD_QUERY_GNN_SAMPLING_WITH_STATE_TYPE =
          SimpleType.simpleImmutableTypeFrom(
  ...
  /**
   * each query has a context on each vertex so for one vertex there is a list of contexts
   * corresponding to list of queries
   */
  public static final Type<ArrayList<QueryGNNSamplingContext>>
      QUERY_GNN_SAMPLING_CONTEXT_LIST_TYPE =
          SimpleType.simpleImmutableTypeFrom(
              TypeName.typeNameOf(TYPES_NAMESPACE, "query_mini_batch_context_list"),
              JSON_OBJ_MAPPER::writeValueAsBytes,
              bytes ->
                  JSON_OBJ_MAPPER.readValue(
                      bytes, new TypeReference<ArrayList<QueryGNNSamplingContext>>() {}));
  ...
  public static final Type<ArrayList<QuerySCCContext>> QUERY_SCC_CONTEXT_LIST_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          ...
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(bytes, new TypeReference<ArrayList<QuerySCCContext>>() {}));
  ...
  public static final Type<ArrayList<QueryCCContext>> QUERY_CC_CONTEXT_LIST_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          ...
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(bytes, new TypeReference<ArrayList<QueryCCContext>>() {}));
  ...
  public static final Type<ArrayList<QuerySSSPContext>> QUERY_SSSP_CONTEXT_LIST_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          ...
          bytes ->
              JSON_OBJ_MAPPER.readValue(
                  bytes, new TypeReference<ArrayList<QuerySSSPContext>>() {}));
  ...
  public static final Type<ArrayList<PageRankContext>> PAGERANK_CONTEXT_LIST_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          ...
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(bytes, new TypeReference<ArrayList<PageRankContext>>() {}));
  ...
  public static final Type<ArrayList<HistoryQuery>> QUERY_HISTORY =
      SimpleType.simpleImmutableTypeFrom(
          ...
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(bytes, new TypeReference<ArrayList<HistoryQuery>>() {}));

  // list
  public static final Type<List<VertexActivity>> VERTEX_ACTIVITIES_LIST_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  public static final Type<PriorityQueue<VertexActivity>> VERTEX_ACTIVITIES_PQ_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          TypeName.typeNameOf(TYPES_NAMESPACE, "vertex_activities_pq"),
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(
                  bytes, new TypeReference<PriorityQueue<VertexActivity>>() {}));

  // bucketed red black tree
  public static final Type<TreeMap<Integer, List<VertexActivity>>> VERTEX_ACTIVITIES_BRBT_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          TypeName.typeNameOf(TYPES_NAMESPACE, "vertex_activities_brbt"),
          JSON_OBJ_MAPPER::writeValueAsBytes,
          bytes ->
              JSON_OBJ_MAPPER.readValue(
                  bytes, new TypeReference<TreeMap<Integer, List<VertexActivity>>>() {}));

  // list
  public static final Type<List<VertexActivity>> BUCKET_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  public static final Type<Set<String>> GRAPH_IDS_TYPE =
      SimpleType.simpleImmutableTypeFrom(
  ...
  public static final Type<Map<Integer, Map<String, String>>> PAGERANK_RESULTS_TYPE =
      SimpleType.simpleImmutableTypeFrom(
          ...
          bytes ->
              JSON_OBJ_MAPPER.readValue(
                  bytes, new TypeReference<Map<Integer, Map<String, String>>>() {}));
