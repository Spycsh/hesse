...
public class QuerySSSPContext {
    ...
    public QuerySSSPContext(String queryId, String userId, int startT, int endT, HashSet<String> vertexSet, Map<String, String> neighbourIdsWithWeight, Map<String, List<String>> paths) {
