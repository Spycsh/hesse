...
/** this class records a vertex's parents for each query and the number of responses to collect */
public class QueryGNNSamplingContext {
  ...
  public QueryGNNSamplingContext(
      String queryId, String userId, ArrayList<GNNSamplingPathContext> GNNSamplingPathContexts) {
  ...
  public void setGNNSamplingPathContexts(
      ArrayList<GNNSamplingPathContext> GNNSamplingPathContexts) {
    this.GNNSamplingPathContexts = GNNSamplingPathContexts;
  }
}
